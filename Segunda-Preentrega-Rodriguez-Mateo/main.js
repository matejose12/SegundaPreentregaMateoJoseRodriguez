...
const producto1 = new productos("termo", "keep","negro", 2500)
const producto2 = new productos("lampara", "planeta","morado", 3500)
const producto3 = new productos("Lampara", "escp","blanco", 1000)
const producto4 = new productos("lapicera", "cross","negro", 1900)
const producto5 = new productos("tele", "keep","negro", 700)
...
const producto9 = new productos("mate", "caserito","negro", 700)
